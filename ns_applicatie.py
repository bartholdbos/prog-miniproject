...
from functions import *  # import alle functies dat niet met layout
from classes import *  # import alle functies dat niet met layout
...
class container():
    ...
    def showinfostation(self, currentStation=False):
        ...
        if valid_station:  # is het een geldige station verkrijg informatie
            station_info = data(valid_station)  # verkrijg informatie
...
class inputStationWindow():
    ...
    def __init__(self, parent, master):
        ...
        self.infButton = Button(master=self.inputStationFrame, command=infobutton, text='Info', height=3, bg='#0079d3',
                                fg='white')  # knop
        self.infButton.config(width='20')  # breedte knop
        self.infButton.pack(padx=5, pady=10, side=LEFT, expand=YES)  # plaats het

        self.ovButton = Button(master=self.inputStationFrame, command=showbutton, text='Ov-chipkaart opladen', height=3,
...
class showInfoWindow():
    ...
    def __init__(self, parent, master):
        ...
        self.infoLabel = Label(master=self.infoFrame, text='', bg='#ffc917', font=(20), relief="groove") # text labeltje
        ...
        self.listbox = Listbox(master=self.infoFrame, yscrollcommand=self.scrollbar.set, height=30) #scrolbare list en bind met scrollbar
